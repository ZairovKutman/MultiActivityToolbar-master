...
public class SmartRate {
    ...
    public interface CallBack_UserRating {
        void userRating(int rating, String comment);
    }
...
//        final long timeDelayToActivate_Ms = 0;
        ...
        final EditText comment_text = dialogView.findViewById(R.id.editText_comment_rate);
            ...
            alert_BTN_ok.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (callBack_userRating != null) {
                        callBack_userRating.userRating(selectedStar, comment_text.getText().toString());
                    }
